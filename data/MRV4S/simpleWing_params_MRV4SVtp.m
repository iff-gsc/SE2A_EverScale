%  ** simple wing aerodynamics parameters (SE2A MRV4S vertical tailplane) **
...
% span, m
wing.geometry.b = 0.445;
% Oswald's efficiency factor, -
wing.geometry.e = 0.8;
% mean chord, m
wing.geometry.c = 0.226;
% sweep, rad
wing.geometry.phi = deg2rad(30);
% taper, -
wing.geometry.z = 0.325;



% maximum C_L for 90deg sideslip angle, -
wing.lateral_polar.c_Lbeta90max = 0.4;

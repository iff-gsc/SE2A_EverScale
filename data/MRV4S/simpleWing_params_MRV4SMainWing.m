%  ** simple wing aerodynamics parameters (SE2A MRV4S main wing) **
...
% span, m
wing.geometry.b = 2.46;
% Oswald's efficiency factor, -
wing.geometry.e = 0.85;
% mean chord, m
wing.geometry.c = 0.21;
% sweep, rad
wing.geometry.phi = deg2rad(13);
% taper, -
wing.geometry.z = 0.25;
